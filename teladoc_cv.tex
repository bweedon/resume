...
\begin{cvletter}
    ...
    \lettersection{Why Teladoc?}
    Teladoc looks like a great company to work for, and Keith has said that he really enjoys working there as well. I think that virtual doctor visits will definitely be a big part of "going" to the doctor's office, especially when you are sick because of the convenience of it as well as being able to stay isolated and not spread germs.

    From the "Senior Software Engineer, Java/Scala" job listing, it looks like you all value having a well-tested application and developers work in a fast-paced development environment. That is something that I am very interested in being a part of.

    \lettersection{Why Me?}
    I believe I would be a good fit for this position because I have worked with Java for most of my professional career. At my current company, I have worked on multiple enterprise level applications and been able to switch applications and start contributing meaningful code quickly.

    I'm looking to grow as a developer and help provide value to a company and their product. I would love to do that while helping make doctor's more accessible and available to people who aren't able to make into their doctor's office.
